...
start = pg.image.load('Tic Tac Toe.png')
...
start = pg.transform.scale(start, (width, height+100))
...
def check_win():
    ...
    for col in range(0, 3):
        if (TTT[0][col] == TTT[1][col] == TTT[2][col]) and (TTT[0][col] is not None):
            ...
            winner = TTT[0][col]
            # рисуем линию победителя
            pg.draw.line(screen, (250, 0, 0), (0, (col + 1) * height / 3 - height / 6),\
                         ((col + 1) * height / 3 - height / 6), 4)
            break
    ...
    if (TTT[0][2] == TTT[1][1] == TTT[2][0]) and (TTT[0][2] is not None):
        ...
        winner = TTT[0][2]
        pg.draw.line(screen, (250, 70, 70), (350, 50), (350, 50), 4)
